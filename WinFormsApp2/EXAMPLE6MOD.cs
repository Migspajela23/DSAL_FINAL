...
namespace WinFormsApp2
{
    public partial class EXAMPLE6MOD : Form
    {
        ...
        private void checkBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            PricesTxtBox.Text = "95.30";
            double price = Convert.ToDouble(PricesTxtBox.Text);
            displayListBox.Items.Add(checkBox5.Text + "          " + PricesTxtBox.Text);
            qtyTxtBox.Text = "0";
            qtyTxtBox.Focus();
        }
        ...
        private void checkBox11_CheckedChanged(object sender, EventArgs e)
        {
            ...
            PricesTxtBox.Text = "95.30";
            double price = Convert.ToDouble(PricesTxtBox.Text);
            displayListBox.Items.Add(checkBox11.Text + "          " + PricesTxtBox.Text);
            qtyTxtBox.Text = "0";
            qtyTxtBox.Focus();
        }
        ...
        private void checkBox13_CheckedChanged(object sender, EventArgs e)
        {
            PricesTxtBox.Text = "95.30";
            double price = Convert.ToDouble(PricesTxtBox.Text);
            displayListBox.Items.Add(checkBox13.Text + "          " + PricesTxtBox.Text);
            qtyTxtBox.Text = "0";
            qtyTxtBox.Focus();
        }
        ...
        private void checkBox16_CheckedChanged(object sender, EventArgs e)
        {
            ...
            PricesTxtBox.Text = "95.30";
            double price = Convert.ToDouble(PricesTxtBox.Text);
            displayListBox.Items.Add(checkBox14.Text + "          " + PricesTxtBox.Text);
            qtyTxtBox.Text = "0";
            qtyTxtBox.Focus();
        }
